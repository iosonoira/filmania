...
@JsonKey(name: 'id') String get id;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'media_id') int get mediaId;@JsonKey(name: 'media_title') String get mediaTitle;@JsonKey(name: 'media_type') String get mediaType;@JsonKey(name: 'poster_path') String? get posterPath;@JsonKey(name: 'watched_at') DateTime? get watchedAt;
...
@override
String toString() {
  return 'WatchedItemDto(id: $id, userId: $userId, mediaId: $mediaId, mediaTitle: $mediaTitle, mediaType: $mediaType, posterPath: $posterPath, watchedAt: $watchedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') String id,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'media_id') int mediaId,@JsonKey(name: 'media_title') String mediaTitle,@JsonKey(name: 'media_type') String mediaType,@JsonKey(name: 'poster_path') String? posterPath,@JsonKey(name: 'watched_at') DateTime? watchedAt
});
...
/// Create a copy of WatchedItemDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? mediaId = null,Object? mediaTitle = null,Object? mediaType = null,Object? posterPath = freezed,Object? watchedAt = freezed,}) {
...
/// Create a copy of WatchedItemDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? mediaId = null,Object? mediaTitle = null,Object? mediaType = null,Object? posterPath = freezed,Object? watchedAt = freezed,}) {
