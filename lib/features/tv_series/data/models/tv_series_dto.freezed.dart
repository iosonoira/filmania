...
mixin _$TVSeriesDto {
 ...
 int get id; String get name; String get overview;@JsonKey(name: 'poster_path') String? get posterPath;@JsonKey(name: 'backdrop_path') String? get backdropPath;@JsonKey(name: 'first_air_date') String? get firstAirDate;@JsonKey(name: 'vote_average') double? get voteAverage;@JsonKey(name: 'status') String? get status;@JsonKey(name: 'episode_run_time') List<int> get episodeRunTime; List<TVSeasonDto> get seasons;
...
@override
String toString() {
  return 'TVSeriesDto(id: $id, name: $name, overview: $overview, posterPath: $posterPath, backdropPath: $backdropPath, firstAirDate: $firstAirDate, voteAverage: $voteAverage, status: $status, episodeRunTime: $episodeRunTime, seasons: $seasons)';
}
...
@useResult
$Res call({
 int id, String name, String overview,@JsonKey(name: 'poster_path') String? posterPath,@JsonKey(name: 'backdrop_path') String? backdropPath,@JsonKey(name: 'first_air_date') String? firstAirDate,@JsonKey(name: 'vote_average') double? voteAverage,@JsonKey(name: 'status') String? status,@JsonKey(name: 'episode_run_time') List<int> episodeRunTime, List<TVSeasonDto> seasons
});
...
/// Create a copy of TVSeriesDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? overview = null,Object? posterPath = freezed,Object? backdropPath = freezed,Object? firstAirDate = freezed,Object? voteAverage = freezed,Object? status = freezed,Object? episodeRunTime = null,Object? seasons = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String overview, @JsonKey(name: 'poster_path')  String? posterPath, @JsonKey(name: 'backdrop_path')  String? backdropPath, @JsonKey(name: 'first_air_date')  String? firstAirDate, @JsonKey(name: 'vote_average')  double? voteAverage, @JsonKey(name: 'status')  String? status, @JsonKey(name: 'episode_run_time')  List<int> episodeRunTime,  List<TVSeasonDto> seasons)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TVSeriesDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String overview, @JsonKey(name: 'poster_path')  String? posterPath, @JsonKey(name: 'backdrop_path')  String? backdropPath, @JsonKey(name: 'first_air_date')  String? firstAirDate, @JsonKey(name: 'vote_average')  double? voteAverage, @JsonKey(name: 'status')  String? status, @JsonKey(name: 'episode_run_time')  List<int> episodeRunTime,  List<TVSeasonDto> seasons)  $default,) {final _that = this;
switch (_that) {
case _TVSeriesDto():
return $default(_that.id,_that.name,_that.overview,_that.posterPath,_that.backdropPath,_that.firstAirDate,_that.voteAverage,_that.status,_that.episodeRunTime,_that.seasons);case _:
  throw StateError('Unexpected subclass');
...
/// Create a copy of TVSeriesDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? overview = null,Object? posterPath = freezed,Object? backdropPath = freezed,Object? firstAirDate = freezed,Object? voteAverage = freezed,Object? status = freezed,Object? episodeRunTime = null,Object? seasons = null,}) {
