...
mixin _$TVSeries {
 ...
 int get id; String get name; String get overview; String? get posterPath; String? get backdropPath; DateTime? get firstAirDate; double get voteAverage; String get status; List<int> get episodeRunTime; List<TVSeason> get seasons;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TVSeries&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&(identical(other.firstAirDate, firstAirDate) || other.firstAirDate == firstAirDate)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.episodeRunTime, episodeRunTime)&&const DeepCollectionEquality().equals(other.seasons, seasons));
}


@override
int get hashCode => Object.hash(runtimeType,id,name,overview,posterPath,backdropPath,firstAirDate,voteAverage,status,const DeepCollectionEquality().hash(episodeRunTime),const DeepCollectionEquality().hash(seasons));

@override
String toString() {
  return 'TVSeries(id: $id, name: $name, overview: $overview, posterPath: $posterPath, backdropPath: $backdropPath, firstAirDate: $firstAirDate, voteAverage: $voteAverage, status: $status, episodeRunTime: $episodeRunTime, seasons: $seasons)';
}
...
@useResult
$Res call({
 int id, String name, String overview, String? posterPath, String? backdropPath, DateTime? firstAirDate, double voteAverage, String status, List<int> episodeRunTime, List<TVSeason> seasons
});
...
/// Create a copy of TVSeries
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? overview = null,Object? posterPath = freezed,Object? backdropPath = freezed,Object? firstAirDate = freezed,Object? voteAverage = null,Object? status = null,Object? episodeRunTime = null,Object? seasons = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String overview,  String? posterPath,  String? backdropPath,  DateTime? firstAirDate,  double voteAverage,  String status,  List<int> episodeRunTime,  List<TVSeason> seasons)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TVSeries() when $default != null:
return $default(_that.id,_that.name,_that.overview,_that.posterPath,_that.backdropPath,_that.firstAirDate,_that.voteAverage,_that.status,_that.episodeRunTime,_that.seasons);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String overview,  String? posterPath,  String? backdropPath,  DateTime? firstAirDate,  double voteAverage,  String status,  List<int> episodeRunTime,  List<TVSeason> seasons)  $default,) {final _that = this;
switch (_that) {
case _TVSeries():
return $default(_that.id,_that.name,_that.overview,_that.posterPath,_that.backdropPath,_that.firstAirDate,_that.voteAverage,_that.status,_that.episodeRunTime,_that.seasons);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String overview,  String? posterPath,  String? backdropPath,  DateTime? firstAirDate,  double voteAverage,  String status,  List<int> episodeRunTime,  List<TVSeason> seasons)?  $default,) {final _that = this;
switch (_that) {
case _TVSeries() when $default != null:
return $default(_that.id,_that.name,_that.overview,_that.posterPath,_that.backdropPath,_that.firstAirDate,_that.voteAverage,_that.status,_that.episodeRunTime,_that.seasons);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TVSeries&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&(identical(other.firstAirDate, firstAirDate) || other.firstAirDate == firstAirDate)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._episodeRunTime, _episodeRunTime)&&const DeepCollectionEquality().equals(other._seasons, _seasons));
}


@override
int get hashCode => Object.hash(runtimeType,id,name,overview,posterPath,backdropPath,firstAirDate,voteAverage,status,const DeepCollectionEquality().hash(_episodeRunTime),const DeepCollectionEquality().hash(_seasons));
...
/// Create a copy of TVSeries
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? overview = null,Object? posterPath = freezed,Object? backdropPath = freezed,Object? firstAirDate = freezed,Object? voteAverage = null,Object? status = null,Object? episodeRunTime = null,Object? seasons = null,}) {
